...
Оваа функција го дефинира движењето на палката на играчот. Во неа прво имаме проверка на тоа дали поинтерот на маусот на играчот ја надминува големината на прозорот во кои е играта, за потоа да  ја придвижи палката
во насоката кон која е поинтерот на маусот. Идеата е превземена од stackoverflow.com , но е имплементирана според нашите потреби.    
- движење на ботот: 
